...
template <>
const google::protobuf::RepeatedPtrField<IVRecordEntry>&
GetFeatureValues<IVRecordEntry>(const Feature& feature) {
  return feature.iv_list().iv_record();
}

template <>
google::protobuf::RepeatedPtrField<IVRecordEntry>*
GetFeatureValues<IVRecordEntry>(Feature* feature) {
  return feature->mutable_iv_list()->mutable_iv_record();
}
