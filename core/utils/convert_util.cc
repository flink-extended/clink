...
const std::string& ConvertUtil::ToString(const proto::Record& any,
                                         std::string& result) {
  result = "";
...
void ConvertUtil::ToFloat(const proto::Record& any, float& value) {
...
void ConvertUtil::ToInt(const proto::Record& feature, int& value) {
  value = 0;
