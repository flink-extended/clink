...
#ifndef CORE_OPERATORS_PLUS_H_
#define CORE_OPERATORS_PLUS_H_
#include <memory>
#include <string>
...
class Plus : public BinaryOperator {
 public:
  Plus();
  Plus(const std::string& first_feature, const std::string& second_feature);
