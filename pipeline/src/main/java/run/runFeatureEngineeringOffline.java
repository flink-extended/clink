...
public class runFeatureEngineeringOffline {
    ...
    @Option(name = "--localOpConfDir", usage = "Local directory for storing libfg's configuration files generated by fit task")
    ...
    public void Main(String[] args) throws Exception {
        ...
        switch (taskMode) {
            case "fit":
                ...
                String tmpConfDir = FileHandler.getTempDir(localOpConfDir);
